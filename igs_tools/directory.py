...
from igs_tools.defines import DataCenter, DataRate, RinexVersion
from igs_tools.utils import classproperty, get_file_properties
            ...
            for rinex_version in self.rinex_versions:
                ...
                for data_rate in self.data_rates:
                    ...
                    for dt in self.dates:
                        print(dt)
                        path = data_center.directory(rinex_version, data_rate, dt)
                        print(path)
                        ...
                        for filename in connection.list(path):
                            ...
                            if (
                                properties is None
                                or properties["rinex_version"]
                                not in self.rinex_versions
                                or (
                                    self.stations
                                    and properties["station"].lower()[0:4]
